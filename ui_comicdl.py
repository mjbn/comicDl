...
class Ui_comicdl(object):
    def setupUi(self, comicdl):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.fromch)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.toch)
        ...
        self.fromch.valueChanged['int'].connect(comicdl.changech) # type: ignore
        self.toch.valueChanged['int'].connect(comicdl.changech) # type: ignore
