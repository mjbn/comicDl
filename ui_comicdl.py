...
class Ui_comicdl(object):
    def setupUi(self, comicdl):
        ...
        self.fromch = QtWidgets.QSpinBox(self.centralwidget)
        ...
        self.toch = QtWidgets.QSpinBox(self.centralwidget)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 212, 25))
